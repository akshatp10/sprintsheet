        ...
        <section className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center justify-between rounded-md border border-lines-hairline px-3 py-2">
                    ...
                    <div className="flex items-center gap-2">
                        <Chip text="Admin" variant="primary" bgColor="bg-accent-wash-active" borderColor="border border-accent-deep" textColor="text-accent-deep" textType="text-type-caption" />
                ...
                {fields.map((field, index) => (
                    ...
                    >
                        <div className="flex items-center gap-2">
                            <UserPanel userName={field.email} />
                        </div>
                        <div className="flex items-center gap-2">
                            <select
